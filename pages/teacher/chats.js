...
export default function TeacherChats() {
        ...
        fetch('/api/notifications/send', {
          ...
          body: JSON.stringify({
            ...
            message: newMessage.trim().length > 50
              ...
              : newMessage.trim(),
            link: '/student/chats', // or '/teacher/chats' depending on role
            senderId: currentUser.id,
  ...
  return (
    <>
      <SeoHead title="Messages" description="Chat with your students" />
              ...
              <div style={{ flex: 1, overflowY: 'auto' }}>
                {filteredConversations.length === 0 ? (
                  <div style={{ padding: '3rem 1.5rem', textAlign: 'center' }}>
                    ...
                    <p style={{ fontSize: '0.8125rem', color: '#94a3b8', marginTop: '0.25rem' }}>Students will message you!</p>
                  </div>
                ) : (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        <div style={{
                          ...
                          {(conv.otherUser?.name || conv.otherUser?.email || 'S')[0].toUpperCase()}
                        </div>
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <p style={{
                            ...
                            {conv.otherUser?.name || conv.otherUser?.email || 'Unknown'}
                          </p>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                      <div style={{
                        ...
                        {(selectedConv.otherUser?.name || selectedConv.otherUser?.email || 'S')[0].toUpperCase()}
                      </div>
                      <div style={{ flex: 1 }}>
                        <p style={{ fontSize: '0.9375rem', fontWeight: '600', color: '#0f172a', margin: 0 }}>
                          {selectedConv.otherUser?.name || selectedConv.otherUser?.email || 'Unknown'}
                        </p>

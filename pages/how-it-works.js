        ...
        <header className="text-center mb-4">
          ...
          <p className="text-muted mb-0">
            {role === "teacher"
              ...
              : "Learn real-life English for your life in the UK — with verified tutors who understand British workplaces, healthcare, education and everyday communication. Choose your plan, book lessons your way, and enjoy loyalty rewards as build lasting confidence."}
          </p>
        </header>

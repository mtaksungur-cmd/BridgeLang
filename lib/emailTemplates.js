...
export async function sendSubscriptionWelcome({ to, userName, plan, viewLimit, messagesLeft }) {
    ...
    const benefits = {
        starter: ['Unlimited tutor profile views', '10 pre-lesson messages per tutor', 'Unlimited messages after your first lesson', '30% review discount on your 2nd lesson'],
        pro: ['Unlimited tutor profile views', '20 pre-lesson messages per tutor', 'Unlimited messages after your first lesson', '35% review discount on your 2nd lesson'],
        vip: ['Unlimited tutor profile views', 'Unlimited pre-lesson messages', 'Unlimited messages after your first lesson', '40% review discount on your 2nd lesson']
    }[plan] || [];
